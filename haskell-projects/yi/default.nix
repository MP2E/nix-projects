...
, derive, Diff, dlist, dyre, filepath, glib, gtk, hashable, hint
, HUnit, lens, mtl, ooPrototypes, pango, parsec, pointedlist
...
cabal.mkDerivation (self: {
  ...
  buildDepends = [
    ...
    dlist dyre filepath glib gtk hashable hint lens mtl ooPrototypes
