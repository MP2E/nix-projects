...
, libXrandr, mtl, parsec, process, regex-compat, stdenv, stm, time
, time-locale-compat, timezone-olson, timezone-series, transformers
, unix, utf8-string, wirelesstools, X11, X11-xft, libXrender
}:
mkDerivation {
  pname = "xmobar";
  version = "0.23";
  ...
  extraLibraries = [ libXpm libXrandr wirelesstools libXrender ];
